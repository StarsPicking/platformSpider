...
from drf_utils.logger import logger
from constant import constant
...
class XiaoHongShuLogin(AbstractLogin):
    ...
    def __init__(self,
        ...
        constant.LOGIN_TYPE = login_type
    ...
    async def begin(self):
        ...
        # if constant.LOGIN_TYPE == "qrcode":
        #     await self.login_by_qrcode()
        # elif constant.LOGIN_TYPE == "phone":
        #     await self.login_by_mobile()
        if constant.LOGIN_TYPE == "cookie":
    ...
    #     cache_client = CacheFactory.create_cache(constant.CACHE_TYPE_MEMORY)
...
if __name__ == "__main__":
    ...
    async def main():
        print(666)
        t = XiaoHongShuLogin("cookie", BrowserContext, Page)
        print(555)
        await t.begin()
